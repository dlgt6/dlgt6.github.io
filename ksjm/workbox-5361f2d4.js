define(["exports"], (function(t) {
    ...
    class o {
        ...
        handleRequest({request: t, event: e}) {
            ...
            let o = i && i.handler;
            const a = t.method;
            if (!o && this.i.has(a) && (o = this.i.get(a)),
            !o)
                return;
            let c;
            try {
    ...
    class R {
        ...
        async cachePut(t, e) {
            ...
            const {cacheName: c, matchOptions: h} = this.u
              ...
              , f = l ? await async function(t, e, s, n) {
                const r = d(e.url, s);
                if (e.url === r)
                    return t.match(e, n);
                ...
                for (const e of o)
                    if (r === d(e.url, s))
                        return t.match(e, n)
            }(u, i.clone(), ["__WB_REVISION__"], h) : null;
            try {
    ...
    function q(t) {
        ...
        return r.searchParams.set("__WB_REVISION__", e),
        {
            cacheKey: r.href,
            url: i.href
        }
    ...
    class L {
        constructor({precacheController: t}) {
            this.cacheKeyWillBeUsed = async({request: t, params: e})=>{
                const s = (null == e ? void 0 : e.cacheKey) || this._.getCacheKeyForURL(t.url);
    ...
    class x extends m {
        ...
        k() {
            ...
            for (const [s,n] of this.plugins.entries())
                n !== x.copyRedirectedCacheableResponsesPlugin && (n === x.defaultPrecacheCacheabilityPlugin && (t = s),
                n.cacheWillUpdate && e++);
    ...
    class O {
        ...
        precache(t) {
            ...
            this.W || (self.addEventListener("install", this.install),
